...
<head>
    ...
    <title>{{env('APP_NAME')}} | 503 Service Unavailable Error</title>
...
<section class="content">
    ...
    <div class="error-page">
        ...
        <div class="error-content">
            <br>
            <h3><i class="fa fa-warning text-yellow"></i> Oops! Service Unavailable Error.</h3>
            <p>Layanan tidak tersedia.
