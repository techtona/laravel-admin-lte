...
<head>
    ...
    <title>{{env('APP_NAME')}} | 404 Halaman tidak ditemukan</title>
...
<section class="content">
    ...
    <div class="error-page">
        ...
        <div class="error-content">
            ...
            <p>Tidak dapat menemukan halaman yang anda cari.
                Silahkan coba <a href="{{route('/')}}">Kembali ke Halaman Home</a>.
            </p>
        </div>
    </div>
</section>
